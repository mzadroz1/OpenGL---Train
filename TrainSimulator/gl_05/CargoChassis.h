...
public:
	CargoChassis(glm::vec3 coordinates, ShaderProgram* shader)
	{
		...
		Object* rod5 = new Cube(coordinates + glm::vec3(1.0f, 0.70f, 3.9f), { 0.15f,0.15f,2.0f }, "metal.png", shader, { 0,0,0 });
		items.push_back(rod5);
		Object* rod6 = new Cube(coordinates + glm::vec3(-1.0f, 0.70f, 3.9f), { 0.15f,0.15f,2.0f }, "metal.png", shader, { 0,0,0 });
		items.push_back(rod6);
		Object* rodWheel5 = new Cylinder(coordinates + glm::vec3(1.1f, 0.70f, 3.7f), { 0.15f,0.15f,0.15f }, "wheel.png", shader, { 0,0,90 });
		items.push_back(rodWheel5);
		Object* rodWheel6 = new Cylinder(coordinates + glm::vec3(-1.1f, 0.70f, 3.7f), { 0.15f,0.15f,0.15f }, "wheel.png", shader, { 0,0,90 });
		items.push_back(rodWheel6);
		Object* rodWheel7 = new Cylinder(coordinates + glm::vec3(1.1f, 0.70f, 5.5f), { 0.15f,0.15f,0.15f }, "wheel.png", shader, { 0,0,90 });
		items.push_back(rodWheel7);
		Object* rodWheel8 = new Cylinder(coordinates + glm::vec3(-1.1f, 0.70f, 5.5f), { 0.15f,0.15f,0.15f }, "wheel.png", shader, { 0,0,90 });
		items.push_back(rodWheel8);


		//przesun¹æ do przodu

		Object* deck = new Cube(coordinates + glm::vec3(0.0f, 1.13f, 2.25f), { 1.45f,0.3f,8.5f }, "black-steel.png", shader);
