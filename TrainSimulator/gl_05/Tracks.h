...
public:
	Tracks(glm::vec3 coordinates, int tracksAmount, ShaderProgram* shader) {
		for (int i = 0; i < tracksAmount; i++) {
			...
			Object* track1 = new Cube(coordinates + glm::vec3(0.85f, 0.18f, i * 2.0f), glm::vec3(0.25f, 0.2f, 2.0f), "metal.png", shader);
			Object* track2 = new Cube(coordinates + glm::vec3(-0.85f, 0.18f, i * 2.0f), glm::vec3(0.25f, 0.2f, 2.0f), "metal.png", shader);
